...
<<<<<<< Updated upstream
Compatible with Reason 5 / Record 1.5 to Reason 8
=======
...
<<<<<<< Updated upstream
Knobs - eight knobs that are mapped to 'sensible' Reason controls. Note that Knob 1 is the top left knob. The knobs support soft takeover so the control won't jump to where the knob is. The value will only be affected when the knob pass thru the current control value.
=======
